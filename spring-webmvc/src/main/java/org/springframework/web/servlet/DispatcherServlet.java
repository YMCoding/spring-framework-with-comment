...
public class DispatcherServlet extends FrameworkServlet {
	...
	protected void initStrategies(ApplicationContext context) {
		...
		// 初始化handlerMapping 用来进行web请求的处理
	 ...
	 */
	// 默认加载所有实现了HandlerMapping接口的bean,按照优先级进行排序
	...
	private void initHandlerAdapters(ApplicationContext context) {
		...
		if (this.handlerAdapters == null) {
			// 如果没有找到对应的handlerAdapters 则尝试加载默认的适配器
	...
	protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			try {
				// 如果是MultiparContent类型的request则转换为MultiparContent
				...
				// 根据当前的handler寻找对应的HanlderAdapter
	...
	private void processDispatchResult(HttpServletRequest request, HttpServletResponse response,
		...
		// 如果在handler实例的处理中返回了view那么需要做页面的处理
	 ...
	 */
	@Nullable
	// spring启动时候，会将所有的映射类型的bean注册到handlerMappings变量中
